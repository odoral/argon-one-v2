...
echo "except Exception:"  >> $shutdownscript
echo "		try:"  >> $shutdownscript
echo "			bus=smbus.SMBus(0)"  >> $shutdownscript
echo "		except Exception:"  >> $shutdownscript
echo "			sys.exit(1)"  >> $shutdownscript

echo 'if len(sys.argv)>1:' >> $shutdownscript
echo '	address=0x1a' >> $shutdownscript
echo '	argonregaddress=0x80' >> $shutdownscript
echo '	argonregsupport=False' >> $shutdownscript
echo '	try:' >> $shutdownscript
echo "		oldval = bus.read_byte_data(address, argonregaddress)"  >> $shutdownscript
echo "		newval = oldval + 1"  >> $shutdownscript
echo "		if newval >= 100:"  >> $shutdownscript
echo "			newval = 98"  >> $shutdownscript
echo "		bus.write_byte_data(address,argonregaddress, newval)"  >> $shutdownscript
echo "		time.sleep(1)"  >> $shutdownscript
echo "		newval = bus.read_byte_data(address, argonregaddress)"  >> $shutdownscript
echo "		argonregsupport = (newval != oldval)"  >> $shutdownscript
echo '	except:' >> $shutdownscript
echo "		argonregsupport = False"  >> $shutdownscript
# Fan off
echo "	if argonregsupport == True:"  >> $shutdownscript
echo "		bus.write_byte_data(address,argonregaddress,0)"  >> $shutdownscript
echo "	else:"  >> $shutdownscript
echo "		bus.write_byte(address,0)"  >> $shutdownscript

# powercut signal
echo '	if sys.argv[1] == "poweroff" or sys.argv[1] == "halt":'  >> $powercutscript
echo "		try:"  >> $powercutscript
echo "			if argonregsupport == True:"  >> $powercutscript
echo "				bus.write_byte_data(address,0x86,1)"  >> $powercutscript
echo "			else:"  >> $powercutscript
echo "				bus.write_byte(address,0xFF)"  >> $powercutscript
echo "		except:"  >> $powercutscript
echo "			rev=0"  >> $powercutscript
...
echo "except Exception:"  >> $powerbuttonscript
echo "		try:"  >> $powerbuttonscript
echo "			bus=smbus.SMBus(0)"  >> $powerbuttonscript
echo "		except Exception:"  >> $powerbuttonscript
echo "			sys.exit(1)"  >> $powerbuttonscript
...
echo '	argonregaddress=0x80' >> $powerbuttonscript
echo '	argonregsupport=False' >> $powerbuttonscript
echo '	try:' >> $powerbuttonscript
echo "		oldval = bus.read_byte_data(address, argonregaddress)"  >> $powerbuttonscript
echo "		newval = oldval + 1"  >> $powerbuttonscript
echo "		if newval >= 100:"  >> $powerbuttonscript
echo "			newval = 98"  >> $powerbuttonscript
echo "		bus.write_byte_data(address,argonregaddress, newval)"  >> $powerbuttonscript
echo "		time.sleep(1)"  >> $powerbuttonscript
echo "		newval = bus.read_byte_data(address, argonregaddress)"  >> $powerbuttonscript
echo "		argonregsupport = (newval != oldval)"  >> $powerbuttonscript
echo '	except:' >> $powerbuttonscript
echo "		argonregsupport = False"  >> $powerbuttonscript
...
echo '		try:' >> $powerbuttonscript
echo '			if argonregsupport == True:' >> $powerbuttonscript
echo '				if block > 0:' >> $powerbuttonscript
echo '					bus.write_byte_data(address,argonregaddress,100)' >> $powerbuttonscript
echo '					time.sleep(1)' >> $powerbuttonscript
echo '				bus.write_byte_data(address,argonregaddress,block)' >> $powerbuttonscript
...
echo '		do' >> $configscript
echo '			echo -n ""$curtemp"C (30-100 only):"' >> $configscript
echo '			curfan=$( get_number )' >> $configscript
echo '			if [ $curfan -ge 30 ]' >> $configscript
echo '			then' >> $configscript
...
echo '	while [ $errorfanflag -eq 1 ]' >> $configscript
echo '	do' >> $configscript
echo '		echo -n "Provide fan speed for "$curtemp"C (30-100) then [ENTER]:"' >> $configscript
echo '		curfan=$( get_number )' >> $configscript
echo '		if [ $curfan -ge 30 ]' >> $configscript
echo '		then' >> $configscript
echo '			errorfanflag=0' >> $configscript
